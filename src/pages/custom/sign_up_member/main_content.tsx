		...
		<PageWrapper title={demoPagesMenu.listPages.subMenu.listBoxed.text}>
			<SubHeader>
				<SubHeaderLeft>
					...
					<span>
						<strong>Danh sách tạo bởi</strong> Admin
					</span>
				</SubHeaderLeft>
				<SubHeaderRight>
					...
					{!!formik.values.categoryName && (
						<CommonFilterTag title='Trạng thái' text={formik.values.categoryName} />
					)}
					...
					{(formik.values.companyA ||
						...
						<CommonFilterTag
							...
							text={
								(formik.values.companyA ? 'Chưa đăng ký, ' : '') +
								(formik.values.companyB ? 'Đã đăng ký, ' : '')
							}
						/>
					)}
					<SubheaderSeparator />
						...
						<DropdownMenu
							...
							<div className='container py-2'>
								<form className='row g-3' onSubmit={formik.handleSubmit}>
									...
									<div className='col-12'>
										<FormGroup>
											<Label htmlFor='categoryName'>Trạng thái</Label>
											<Select
												id='categoryName'
												ariaLabel='Category'
												placeholder='Tất cả'
												list={[
													{ value: '', text: 'Tất cả' },
													{ value: 'Activated', text: 'Đã kích hoạt' },
													{ value: 'Not-Activated', text: 'Chưa kích hoạt' },
												]}
												onChange={formik.handleChange}
									...
									<div className='col-12'>
										<FormGroup>
											<Label htmlFor='company'>Vai trò</Label>
											<ChecksGroup>
												<Checks
													id='companyA'
													label='Cộng tác viên'
