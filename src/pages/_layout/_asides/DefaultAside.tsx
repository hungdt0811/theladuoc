			...
			<AsideBody>
				{!doc && (
					<>
						...
						<NavigationLine />
						<Navigation menu={developmentMenu} id='manager-page' />



						{/* <Navigation menu={attendanceMenu} id='attendance-page' />
						<Navigation menu={exerciseMenu} id='exercise-page' />
						<Navigation menu={decentralizationMenu} id='decentralization-page' />
						<Navigation menu={hrManagerMenu} id='hr-Manager-page' />
						<Navigation menu={featureMenu} id='feature-page' />
